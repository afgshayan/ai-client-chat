...
import com.aiclient.chat.data.remote.AnthropicApiClient
...
class AiClientApp : Application() {
    ...
    lateinit var chatRepository: ChatRepository
        private set
    lateinit var apiClient: AnthropicApiClient
        private set
    ...
    override fun onCreate() {
        ...
        chatRepository = ChatRepository(db.conversationDao(), db.messageDao())
